        ...
        <div class="w-full lg:w-1/2 bg-white flex items-center justify-center p-8">
            <div class="w-full max-w-md space-y-8">
                <div class="flex lg:hidden items-center gap-2 mb-6">
                    ...
                    <span class="text-xl font-bold text-slate-900">OneLib</span>
                </div>
            ...
            <div class="absolute bottom-6 text-center lg:text-left w-full lg:w-auto px-8">
                <span class="text-xs text-slate-300 lg:text-slate-400">© 2025 SATU University Library System v1.0</span>
            </div>
        </div>
    </div>
